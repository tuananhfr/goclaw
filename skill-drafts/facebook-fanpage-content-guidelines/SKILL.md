...
- Use 5-7 hashtags for normal posts unless the project requests otherwise.
- Mix fixed brand hashtags with contextual hashtags.
...
- Icons may be used in the title or at the start of short content sections.
