---
name: BakeTek Visual Content Profile
description: Page-specific visual profile for BakeTek that maps sales, recipe-support, tips, ingredient knowledge, and lifestyle routes to the right image style, subject focus, text density, and real-photo vs AI usage rules.
---

# BakeTek Visual Content Profile

Use this skill as the page-specific visual profile for `BakeTek - Cong nghe va Nguyen lieu lam banh`.
...
This is the most important visual route for BakeTek.
...
- posting recipe visuals that look completely disconnected from what BakeTek sells
...
- keep the top-right and bottom-centre zones clean for the watermark

Do not place these in the top-right watermark zone:
...
Before approving a BakeTek visual, verify:
...
- the top-right and bottom-centre watermark zones remain clean
- no false packaging, false labels, or unsupported claims are implied visually

## Final Rule

For BakeTek, a good visual should make the post route obvious at a glance and still support the page's sales-first mission.
