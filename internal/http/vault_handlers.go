...
func (h *VaultHandler) RegisterRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET /v1/vault/documents/{docID}/content", h.auth(h.handleGetDocumentContent))
	mux.HandleFunc("PUT /v1/vault/documents/{docID}/content", h.auth(h.handleUpdateDocumentContent))
	...
	mux.HandleFunc("GET /v1/agents/{agentID}/vault/documents/{docID}/content", h.auth(h.handleGetDocumentContent))
	mux.HandleFunc("PUT /v1/agents/{agentID}/vault/documents/{docID}/content", h.auth(h.handleUpdateDocumentContent))
