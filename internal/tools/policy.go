...
var builtinToolGroups = map[string][]string{
	...
	"ui":         {"browser"},
	"automation": {"cron", "facebook_post_with_comments"},
	"messaging":  {"message", "create_forum_topic", "list_group_members"},
	"team":       {"team_tasks"},
	"vault":      {"vault_search", "vault_read"},
	"media":      {"read_image", "read_document", "read_audio", "read_video", "create_image", "create_video", "create_audio", "apply_watermark", "facebook_post_with_comments", "product_visual_profile"},
	...
	"goclaw": {
		...
		"create_image", "create_video", "create_audio", "apply_watermark", "product_visual_profile",
...
var toolProfiles = map[string][]string{
	...
	"coding":    {"group:fs", "group:runtime", "group:sessions", "group:memory", "group:web", "group:vault", "read_image", "create_image", "apply_watermark", "facebook_post_with_comments", "skill_search"},
