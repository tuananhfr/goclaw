...
func SeedDefaultModels(r *InMemoryRegistry) {
	...
	// OpenAI models
	for _, s := range []ModelSpec{
		{ID: "gpt-5.6", Provider: "openai", ContextWindow: 2_000_000, MaxTokens: 200_000, Reasoning: true, Vision: true, TokenizerID: "o200k_base"},
		{ID: "gpt-5.5", Provider: "openai", ContextWindow: 1_000_000, MaxTokens: 200_000, Reasoning: true, Vision: true, TokenizerID: "o200k_base"},
		// gpt-5.4 retires from Codex (ChatGPT sign-in) on 2026-08-31 but stays on
		// the OpenAI API, so it remains seeded here.
