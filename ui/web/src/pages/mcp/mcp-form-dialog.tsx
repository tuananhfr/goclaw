...
function restoreGoogleDrive(
  ...
  return {
    ...
    visual_format_provider: settings?.visual_format_provider ?? "",
    visual_format_model: settings?.visual_format_model ?? "",
...
function stripGoogleDriveForSettings(drive: MCPFormData["googleDrive"]) {
  return {
    ...
    visual_format_provider: drive.visual_format_provider || undefined,
    visual_format_model: drive.visual_format_model || undefined,
